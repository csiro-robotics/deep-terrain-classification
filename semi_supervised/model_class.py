...
# This file includes the class that includes the deep learning model for semi-supervised terrrian classification: the classification part

import tensorflow as tf
from tensorflow import nn
from utils import lazy_property

# The class does the terrain classification and it includes RNN layers and a Fully Connected Layer (FCL)
class Classification:
    ...
    def optimize(self):
        ...
        # The stage 0 is for FE Semi-supervised learning and the stage 1 is for FE+FT Semi-supervised learning 
